...
const ProvaSocialSection = () => {
    return (
        <Styled.Section>
            ...
            <ProvaSocial reverse={false} logoName={"notustorres"} infoBigText1={"2619%"} infoSmallText1={"no ROI"} infoBigText2={"R$ 262.000"} infoSmallText2={"a mais de faturamento no período de 3 meses"} infoText={"R$ 9.000"} infoSmallText3={"em 3 meses"} />
        </Styled.Section>
    )
}
